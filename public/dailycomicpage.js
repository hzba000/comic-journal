...
function customCheck(){
    ...
    // loader setup
    $('.draw-loader').removeClass('hidden');
    getComic();
}
...
function displayDataApi(data){
    ...
    if(test == true){data.img = customURL;}
        ...
        customURL = data.img;
        alert("Your comic is ready, press okay to start writing! If you tried to use your own comic, you can try again. Just click 'Add a comic' in the menu.");
    }
